...
# %% auto 0
__all__ = ['get_fans', 'cplx_kaiming_normal_', 'cplx_xavier_normal_', 'cplx_kaiming_uniform_', 'cplx_xavier_uniform_',
           'cplx_trabelsi_standard_', 'cplx_trabelsi_independent_', 'cplx_uniform_independent_', 'ones_', 'zeros_']
